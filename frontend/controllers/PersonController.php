...
class PersonController extends Controller
{
    ...
    public function actionView($id)
    {
        ...
        $followupModel = $model = Followup::find()
        ...
        $person_dup = Person::find()->select('id')->where(['cid' => $personModel->cid, 'date_in' => $personModel->date_in])->count();
    ...
    public function actionDelete($id)
    {
        ...
        $person = Person::find()->select('id')->where(['cid' => $cid])->all();
        if ($person == NULL) {
            Followup::deleteAll(['cid' => $cid]);
        }
    ...
    {
        if (($model = Followup::find()->where('cid > :cid', [':cid' => $id])->one()) !== null) {
            return $model;
        }
