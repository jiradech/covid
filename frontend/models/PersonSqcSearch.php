 ...
 */
class PersonSqcSearch extends PersonSqc
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['cid', 'prename', 'fname', 'lname', 'sex', 'occupation', 'phone_number', 'date_in', 'addr_tambon', 'addr_ampur', 'addr_province', 'nation', 'house_type', 'q_from_risk_country', 'q_close_to_case', 'risk_from_risk_country', 'risk_korea_worker', 'risk_cambodia_border', 'risk_from_bangkok', 'q_family_from_risk_country', 'q_close_to_foreigner', 'q_healthcare_staff', 'q_close_to_group_fever', 'risk_place', 'risk_group_place', 'risk_case_place', 'note', 'reporter_name', 'reporter_phone', 'date_stamp','move_province','move_ampur','move_tambon','move_vill_no','remark'], 'safe'],
        ];
    }
