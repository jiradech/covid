...
<div class="followup-form">
    ...
    <div class="panel panel-primary">
            <div class="panel-heading">
                <h4 class="panel-title"><i class="fa fa-user"></i> ข้อมูลติดตามบุคคลเข้าพักโรงแรมและกิจการให้เช่าที่พัก</h4>
            </div>
...
<div class="row">
    ...
    // <?=Select2::widget([
       ...
       <?= $form->field($model, 'remark')->radioList(array('0'=>'ติดตามไม่ได้', '1'=>'ย้ายออกนอกพื้นที่','2'=>'ยังอยู่ในพื้นที่ และทำ Home Quarantine', '3' => 'ยังอยู่ในพื้นที่ ฝ่าฝืนหรือไม่ทำ Home Quarantine', '4' => 'ยังอยู่ในพื้นที่ Local Quarantine', '5' => 'ส่ง รพ.'), ['separator'=>'<br/><br/>']); ?>
