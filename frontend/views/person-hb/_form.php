    ...
    <?php $form = ActiveForm::begin(); ?>
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                ...
                <h4 class="panel-title"><i class="fa fa-user"></i> ข้อมูลผู้ใช้บริการ / ผู้เข้าพัก</h4>
    ...
    <div class="col-md-4">
           ...
           // 'data'=> [],
            'pluginOptions'=>[
                ...
                'url'=>Url::to(['/person-hb/get-mamphur'])
            ]
        ]); ?>
        </div>
        ...
        <div class="col-md-4">
            ...
            'pluginOptions'=>[
                ...
                'url'=>Url::to(['/person-hb/get-mtambon'])
            ]
        ]); ?>
        </div>
        <div class="col-md-3">
...
<div class="panel panel-primary">
            <div class="panel-heading">
                <h4 class="panel-title"><i class="fa fa-user"></i> ข้อมูลการเข้ามาพัก</h4>
            </div>
            <div class="panel-body">
    ...
    <div class="col-md-4">
        ...
        'data' => ArrayHelper::map(PersonHb::find()
      ...
      <div class="row">
        <div class="col-md-4"><h6>ที่ตั้ง ระบุ</h6></div></div>
        <div class="row">	
