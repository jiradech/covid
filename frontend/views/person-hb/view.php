            ...
            <div class="countcorona">
                ...
                <div class="countcorona-area">
                    ...
                    <?php
                        if ($person_dup > 1) {
                    ?>
<a href="<?=Url::to(['person-hb/index', 'PersonSearch[cid]' => $model->cid, 'PersonSearch[date_in]' => $model->date_in])?>"><h5 style="color: red">พบมีการบันทึกคนซ้ำในระบบ <?=$person_dup?> ราย กรุณาตรวจสอบ [คลิก]</h5></a>
                    ...
                    <p>
                        <?= Html::a('เพิ่มข้อมูลผู้ใช้บริการ / ผู้เข้าพัก ', ['person-hb/create'], ['class' => 'btn btn-success']) ?>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="row">
                             ...
                             <div class="row">
                                <div class="col-md-12">เดินทางมาจาก : บ้านเลขที่ 
                                 <!--    <?= $model->addr_number; ?> -->
                                    หมู่ <?= ArrayHelper::getValue($model->getVillageArray($model->move_tambon . $model->addr_vill_no), $model->move_tambon . $model->addr_vill_no, 'ไม่ระบุ') ?>
                                    ตำบล<?= ArrayHelper::getValue($model->getTambonArray($model->move_tambon), $model->move_tambon, 'ไม่ระบุ') ?>
                                    อำเภอ<?= ArrayHelper::getValue($model->getAmphurArray($model->move_ampur), $model->move_ampur, 'ไม่ระบุ') ?>
                                    จังหวัด<?=ArrayHelper::getValue($model->getProvinceArray($model->move_province), $model->move_province, 'ไม่ระบุ')?></div>
                        ...
                        'attributes' => [
                           ...
                           // 'remark',
                            [
                                ...
                                'value' => $model->remark .' ( '.$model->addr_number.' หมู่ '.
                            ...
                            [
                                ...
                                'value' => Yii::$app->thai->thaidate('d F Y', strtotime($model->date_in)).' ถึงวันที่ '.Yii::$app->thai->thaidate('d F Y', strtotime($model->date_out))
                    ...
                    <p>
                        <?= Html::a('เพิ่มรายงานติดตามผู้เดินทาง 14 วัน', ['followup-hb/create', 'cid' => $model->id, 'person_id' => $model->id], ['class' => 'btn btn-success']) ?>
                    </p>
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'controller' => 'followup-hb',
                                //'buttonOptions'=>['class'=>'btn btn-default'],
                                //'template'=>'<div class="btn-group btn-group-sm text-center" role="group">{view} {update} {delete} </div>',
                                'options'=> ['style'=>'width:80px;'],
                                'buttons' => [     
                                    'view' => function ($url, $d) use ($model) {
                                        return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', Url::to(['followup-hb/view', 'id' => $d['id'], 'person_id' => $model->id] ), [
                                                    'title' => Yii::t('app', 'ดู'),
                                        ]);
                                    },                  
                                    'update' => function ($url, $d) use ($model) {
                                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Url::to(['followup-hb/update', 'id' => $d['id'], 'person_id' => $model->id] ), [
