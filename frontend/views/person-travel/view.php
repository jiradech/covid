            ...
            <div class="countcorona">
                ...
                <div class="countcorona-area">
                    ...
                    <?php
                        if ($person_dup > 1) {
                    ?>
<a href="<?=Url::to(['person/index', 'PersonSearch[cid]' => $model->cid, 'PersonSearch[date_in]' => $model->date_in])?>"><h5 style="color: red">พบมีการบันทึกคนซ้ำในระบบ <?=$person_dup?> ราย กรุณาตรวจสอบ [คลิก]</h5></a>
                    ...
                    <p>
                        <?= Html::a('เพิ่มข้อมูลผู้เดินทาง ', ['person-travel/create'], ['class' => 'btn btn-success']) ?>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="row">
                             ...
                             <div class="row">
                                <div class="col-md-12">ที่พักอาศัย : บ้านเลขที่ 
                                     <?= $model->addr_number; ?> 
                                    ...
                                    จังหวัด<?=ArrayHelper::getValue($model->getProvinceArray($model->addr_province), $model->addr_province, 'ไม่ระบุ')?></div>
                        ...
                        'attributes' => [
                           ...
                           // 'remark',
                            [
                                ...
                                'value' => ' จังหวัด'.ArrayHelper::getValue($model->getProvinceArray($model->origin_province), $model->origin_province, 'ไม่ระบุ')
                            ...
                            [
                                ...
                                'value' => $model->move_number.' หมู่ '.
                                ArrayHelper::getValue($model->getVillageArray($model->move_tambon . $model->move_vill_no), $model->move_tambon . $model->move_vill_no, 'ไม่ระบุ').' ตำบล'.ArrayHelper::getValue($model->getTambonArray($model->move_tambon), $model->move_tambon, 'ไม่ระบุ').' อำเภอ'.ArrayHelper::getValue($model->getAmphurArray($model->move_ampur), $model->move_ampur, 'ไม่ระบุ').' จังหวัด'.ArrayHelper::getValue($model->getProvinceArray($model->move_province), $model->move_province, 'ไม่ระบุ')
                            ...
                            [
                                ...
                                'value' => Yii::$app->thai->thaidate('d F Y', strtotime($model->date_in))
                            ...
                            [
                                ...
                                'attribute' => 'q_sick_sign',
                                 'format' => 'raw',
                                'value' => $model->q_sick_sign ? '<span class="label label-danger">ใช่</span>' : '<span class="label label-success">ไม่ใช่</span>',
                            ...
                            // [
                            //     'attribute' => 'risk_korea_worker',
                            //     //'label'=>'ท่านเป็นแรงงานกลับจากประเทศเกาหลีใต้ ใช่หรือไม่?',
                            //     'format' => 'raw',
                            //     'value' => $model->risk_korea_worker ? '<span class="label label-danger">ใช่</span>' : '<span class="label label-success">ไม่ใช่</span>',
                            ...
                            //'risk_korea_worker',
                            // [
                            //     'attribute' => 'risk_cambodia_border',
                            //     'format' => 'raw',
                            //     'value' => $model->risk_cambodia_border ? '<span class="label label-danger">ใช่</span>' : '<span class="label label-success">ไม่ใช่</span>',
                            // ],
                            // //'risk_cambodia_border',
                            // [
                            //     'attribute' => 'risk_from_bangkok',
                            //     'format' => 'raw',
                            //     'value' => $model->risk_from_bangkok ? '<span class="label label-danger">ใช่</span>' : '<span class="label label-success">ไม่ใช่</span>',
                            // ],
                            //'risk_from_bangkok',
                            // [
                            //     'attribute' => 'q_family_from_risk_country',
                            //     'format' => 'raw',
                            //     'value' => $model->q_family_from_risk_country ? '<span class="label label-danger">ใช่</span>' : '<span class="label label-success">ไม่ใช่</span>',
                            // ],
                            ...
                            // [
                            //     'attribute' => 'q_healthcare_staff',
                            //     'format' => 'raw',
                            //     'value' => $model->q_healthcare_staff ? '<span class="label label-danger">ใช่</span>' : '<span class="label label-success">ไม่ใช่</span>',
                            // ],
                            // //'q_healthcare_staff',
                            // [
                            //     'attribute' => 'q_close_to_group_fever',
                            //     'format' => 'raw',
                            //     'value' => $model->q_close_to_group_fever ? '<span class="label label-danger">ใช่</span>' : '<span class="label label-success">ไม่ใช่</span>',
                            // ],
                            ...
                            //'risk_group_place',
                            // [
                            //     'attribute' => 'risk_case_place',
                            //     'format' => 'raw',
                            //     'value' => $model->risk_case_place ? '<span class="label label-danger">ใช่</span>' : '<span class="label label-success">ไม่ใช่</span>',
                            // ],
                            //'risk_case_place',
                            [
                                'attribute' => 'note',
                    ...
                    <p>
                        <?= Html::a('เพิ่มรายงานติดตามผู้เดินทาง 14 วัน', ['followup-travel/create', 'cid' => $model->id, 'person_id' => $model->id], ['class' => 'btn btn-success']) ?>
                    </p>
                    ...
                    <?= GridView::widget([
                        'dataProvider' => $dataProviderFollowup,
                        'columns' => [
                            ...
                            [
                                ...
                                'controller' => 'followup-travel',
                                //'buttonOptions'=>['class'=>'btn btn-default'],
                                //'template'=>'<div class="btn-group btn-group-sm text-center" role="group">{view} {update} {delete} </div>',
                                'options'=> ['style'=>'width:80px;'],
                                'buttons' => [     
                                    'view' => function ($url, $d) use ($model) {
                                        return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', Url::to(['followup-travel/view', 'id' => $d['id'], 'person_id' => $model->id] ), [
                                                    'title' => Yii::t('app', 'ดู'),
                                        ]);
                                    },                  
                                    'update' => function ($url, $d) use ($model) {
                                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Url::to(['followup-travel/update', 'id' => $d['id'], 'person_id' => $model->id] ), [
