    ...
    <?php $form = ActiveForm::begin(); ?>
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                ...
                <h4 class="panel-title"><i class="fa fa-user"></i> ข้อมูลบุคคลเคลื่อนย้ายเข้าพื้นที่</h4>
...
<div class="row">
      ...
      <div class="row">
        <div class="col-md-4"><h6>เข้ามาพักที่</h6></div></div>
        <div class="row">	
        ...
        <div class="col-md-4"><?= $form->field($model, 'house_type')->radioList(
    ...
    <div class="row">
    <div class="col-md-12">
                <?= $form->field($model, 'remark')->widget(Select2::classname(), [
        
        'data' => ArrayHelper::map(LocalQuarantine::find()
                                        ->select(['local_name','concat("อ.", amphur, " ",local_name) as  amphur'])
                                          //  ->where(['xx' => xx])
                                            //->orderBy('xx')
                                            ->orderBy('amphur')->all(),'local_name','amphur'),
        'options' => [
            'id'=>'local_name',
 ...
 <div class="panel panel-primary">
            <div class="panel-heading">
                <h4 class="panel-title"><i class="fa fa-user"></i> ข้อมูลเฝ้าระวัง</h4>
            </div>
            <div class="panel-body">

<div class="row">

	<div class="col-md-4"><b>กรณีเดินทางมาจากต่างจังหวัด ระบุ</b></div></div>
        <div class="row">
