...
<a href="<?=Url::to(['person/index', 'PersonSearch[cid]' => $model->cid, 'PersonSearch[date_in]' => $model->date_in])?>"><h5 style="color: red">พบมีการบันทึกคนซ้ำในระบบ <?=$person_dup?> ราย กรุณาตรวจสอบ [คลิก]</h5></a>
                    ...
                    <p>
                        <?= Html::a('เพิ่มข้อมูลบุคคลเคลื่อนย้ายเข้าพื้นที่', ['person/create'], ['class' => 'btn btn-success']) ?>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-md-2">เบอร์โทรศัพท์ : <?= $model->phone_number; ?></div>
                            </div>
                            <div class="row">
                    ...
                    <p>
                        <?= Html::a('เพิ่มรายงานติดตามเฝ้าระวัง 14 วัน', ['followup/create', 'cid' => $model->id, 'person_id' => $model->id], ['class' => 'btn btn-success']) ?>
                    </p>
                            ...
                            [
                                ...
                                'buttons' => [     
                                    'view' => function ($url, $d) use ($model) {
                                        return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', Url::to(['followup/view', 'id' => $d['id'], 'person_id' => $model->id] ), [
                                                    'title' => Yii::t('app', 'ดู'),
                                        ]);
                                    },                  
                                    'update' => function ($url, $d) use ($model) {
                                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Url::to(['followup/update', 'id' => $d['id'], 'person_id' => $model->id] ), [
