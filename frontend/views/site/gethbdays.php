...
$this->title = 'รายชื่อบุคคลอยู่ระหว่างพักโรงแรม';
        ...
        <div class="corona-wrap">
            ...
            <div class="countcorona">
                <div class="countcorona-area">
                    ...
                    <?= $this->render('/locate/_form_gethb', [
                        'model' => $model,
                        'tambon' => $tambon,
                        'village' => $village
                    ]) ?>
...
<table id="example" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th>เพศ</th>
                                <th>อายุ</th>
                                <th>วันที่<br>เข้า-ออก ที่พัก</th>
                                <th>โรงแรม/รีสอร์ท</th>
                                <th>ข้อมูล</th>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        <?= Yii::$app->thai->thaidate('d F Y', strtotime($value['date_in'])) ?><br>
                                        <?= Yii::$app->thai->thaidate('d F Y', strtotime($value['date_out'])) ?></td>
                                    <td>
                                        <b><?=$value['remark']?></b> <br>
                                        <?= $value['addr_number'] ?> ม.<?= intval($value['addr_vill_no']) ?> บ.<?= $value['vill_name'] ?> อ.<?= $value['ampurname'] ?></td>
                                    <td><?= $desc ?></td>
                                    ...
                                    <td>
                                        <a href="<?= Url::to(['person-hb/view', 'id' => $value['id']]) ?>" title="ดู" aria-label="ดู"><span class="glyphicon glyphicon-eye-open"></span></a>
                                    </td>
