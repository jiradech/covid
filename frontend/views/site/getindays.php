...
$this->title = 'รายชื่อบุคคลอยู่ระหว่างคุมไว้สังเกต';
        ...
        <div class="corona-wrap">
            ...
            <div class="countcorona">
                <div class="countcorona-area">
                    ...
                    <?= $this->render('/locate/_form_getin', [
                        'model' => $model,
                        'tambon' => $tambon,
                        'village' => $village
                    ]) ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= $value['sex'] ?></td>
                                    <td><?= $value['age'] ?></td>
                                    <td class="text-nowrap"><?= Yii::$app->thai->thaidate('d F Y', strtotime($value['date_in'])) ?></td>
                                    ...
                                    <td>
                                        <a href="<?= Url::to(['person-sqc/view', 'id' => $value['id']]) ?>" title="ดู" aria-label="ดู"><span class="glyphicon glyphicon-eye-open"></span></a>
                                    </td>
